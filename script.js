...
vida.
          ...
          <p class="source-attr">José Guadalajara · <em>La maldición del rey sabio</em> · p. 90</p>
    ...
    render: () => `
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          <p class="source-attr">José Guadalajara · <em>La maldición del rey sabio</em> · p. 340</p>
          <div class="source-text" style="border-left-color:#5577cc;">
    ...
    render: () => `
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          <p class="source-attr">José Guadalajara · <em>La maldición del rey sabio</em> · pp. 193-194</p>
          <div class="source-text" style="border-left-color:#5577cc;">
    ...
    render: () => `
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          <p class="source-attr">José Guadalajara · <em>La maldición del rey sabio</em> · pp. 38-40</p>
          <div class="source-text" style="border-left-color:#5577cc;">
...
—No os deis por vencido tan pronto. Estudiad el encargo durante dos semanas. Si lo conseguís quiero que se mantenga en secreto. Nadie debe portar otra semejante y tampoco debe saberse de su existencia. Para no despertar suspicacias o rumores, os encargaré una armadura completa que deberé tener lista dentro de seis meses. La cota de malla será un componente más de la armadura.»
          ...
          <p class="source-attr">Javier Oñoro · <em>El herrero del rey sabio</em> · pp. 6-8</p>
          <div class="source-text" style="border-left-color:#5577cc;">
